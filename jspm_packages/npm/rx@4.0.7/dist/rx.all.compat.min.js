...
(function(process) {
  (function(a) {
    ...
    function s(a, b, c, d, e, f) {
      var g = Xb(a),
          ...
          i = ub,
          j = ub;
      g || (i = Tb.call(a), i === tb ? i = Bb : i !== Bb && (g = p(a))), h || (j = Tb.call(b), j === tb && (j = Bb));
      var k = i === Bb && !Wb(a),
          n = j === Bb && !Wb(b),
          o = i === j;
      if (o && !g && !k)
    ...
    function t(a, b, c, d, e) {
      return a === b ? !0 : null == a || null == b || !_(a) && !n(b) ? a !== a && b !== b : s(a, b, t, c, d, e);
    }
    function u(a, b) {
    ...
    function E(b) {
      ...
      if (!d && "string" == typeof b)
        return c = new z(b), c[mb]();
      if (!d && b.length !== a)
        return c = new B(b), c[mb]();
      if (!d)
    ...
    function G(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && D(b) ? (b = F(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > od ? od : b) : b;
    }
    function H(a, b) {
      return sc(a) || (a = zc), new qd(b, a);
    }
    function I(a, b) {
    ...
    function U(a, b, c, d) {
      ...
      return new vg(function(b) {
        return a.subscribe(new hf(b, a, e, d));
      }, a);
    }
    function V(a) {
      return a ? Vc.isObservable(a) ? a : Wa(a) ? Vc.fromPromise(a) : $(a) || Z(a) ? rf.call(this, a) : Xa(a) ? Y.call(this, a) : pb(a) || ob(a) ? W.call(this, a) : _(a) ? X.call(this, a) : a : a;
    }
    function W(a) {
      return Vc.from(a).concatMap(function(a) {
        return Vc.isObservable(a) || _(a) ? V.call(null, a) : Pa.Observable.just(a);
      }).toArray();
    }
    function X(b) {
      function c(b, c) {
      ...
      for (var d = new b.constructor,
        ...
        var i = e[g],
            j = V.call(this, b[i]);
        j && Vc.isObservable(j) ? c(j, i) : d[i] = b[i];
      }
      return Vc.forkJoin.apply(Vc, f).map(function() {
        return d;
      });
    }
    function Y(a) {
      var b = this;
      return new vg(function(c) {
        a.call(b, function() {
          var a = arguments[0],
              b = arguments[1];
          if (a)
    ...
    function ha(a, b, c) {
      return new vg(function(d) {
        ...
        var f,
            ...
            i = !1,
            j = new Array(2);
        return new mc(a.subscribe(function(a) {
          e(a, 0);
        }, function(a) {
          j[1] ? d.onError(a) : f = a;
        }, function() {
    ...
    function ia(a, b) {
      return a.groupJoin(this, b, md, function(a, b) {
        return b;
      });
    }
    function ja(a) {
      ...
      return new vg(function(c) {
        var d = new zg,
            e = new cc,
            f = new oc(e);
        return c.onNext(_b(d, f)), e.add(b.subscribe(function(a) {
          d.onNext(a);
        }, function(a) {
          d.onError(a), c.onError(a);
        }, function() {
          d.onCompleted(), c.onCompleted();
        })), Wa(a) && (a = gd(a)), e.add(a.subscribe(function(a) {
          d.onCompleted(), d = new zg, c.onNext(_b(d, f));
        }, function(a) {
          d.onError(a), c.onError(a);
        }, function() {
          d.onCompleted(), c.onCompleted();
      ...
      return new vg(function(c) {
        function d() {
          ...
          e.setDisposable(i), i.setDisposable(b.take(1).subscribe(Qa, function(a) {
            ...
            h.onCompleted(), h = new zg, c.onNext(_b(h, g)), d();
          }));
        }
        var e = new lc,
            f = new cc(e),
            g = new oc(f),
            h = new zg;
        return c.onNext(_b(h, g)), f.add(b.subscribe(function(a) {
          h.onNext(a);
        }, function(a) {
          h.onError(a), c.onError(a);
        }, function() {
    ...
    function ra(a, b, c) {
      this.joinObserverArray = a, this.onNext = b, this.onCompleted = c, this.joinObservers = new Pf;
      for (var d = 0,
    ...
    function va(a, b, c) {
      return new vg(function(d) {
        ...
        return e = a.materialize().timestamp(c).subscribe(function(a) {
          ...
          }), k = !f, f = !0), k && (null !== h ? d.onError(h) : (e = new kc, g.setDisposable(e), e.setDisposable(c.scheduleRecursiveFuture(null, b, function(a, b) {
            var e,
                g,
                k,
                l;
 ...
 while (null !== k);
    ...
    function xa(a, b, c) {
      var d,
          e;
      return Xa(b) ? e = b : (d = b, e = c), new vg(function(b) {
        function c() {
    ...
    function za(a, b) {
      return new vg(function(c) {
        ...
        return h.setDisposable(a.subscribe(function(a) {
          ...
          f = !0, h.dispose();
        })), new mc(h, b.subscribe(d, function(a) {
          c.onError(a);
        }, d));
      }, a);
    }
    function Aa(a, b, c, d) {
      return Xa(b) && (d = c, c = b, b = vd()), Vc.isObservable(d) || (d = Bd(new Zf)), new vg(function(e) {
        function f(a) {
          function b() {
            return l = c === k;
          }
    ...
    function Ba(a, b, c, d) {
      return sc(c) && (d = c, c = Bd(new Zf)), c instanceof Error && (c = Bd(c)), sc(d) || (d = Ec), Vc.isObservable(c) || (c = Bd(new Zf)), new vg(function(e) {
        function f() {
          var a = g;
          k.setDisposable(d.scheduleFuture(null, b, function() {
            j = g === a, j && (Wa(c) && (c = gd(c)), i.setDisposable(c.subscribe(e)));
          }));
        }
        var g = 0,
            h = new kc,
    ...
    Array.prototype.every || (Array.prototype.every = function(a) {
      var b = Object(this),
          c = fb && db.call(this) === stringClass ? this.split("") : b,
          d = c.length >>> 0,
          e = arguments[1];
      if (db.call(a) !== funcClass)
        throw new TypeError(a + " is not a function");
      for (var f = 0; d > f; f++)
    ...
    var gb = Pa.EmptyError = function() {
      this.message = "Sequence contains no elements.", Error.call(this);
    };
    gb.prototype = Object.create(Error.prototype), gb.prototype.name = "EmptyError";
    var hb = Pa.ObjectDisposedError = function() {
      this.message = "Object has been disposed", Error.call(this);
    };
    hb.prototype = Object.create(Error.prototype), hb.prototype.name = "ObjectDisposedError";
    var ib = Pa.ArgumentOutOfRangeError = function() {
      this.message = "Argument out of range", Error.call(this);
    };
    ib.prototype = Object.create(Error.prototype), ib.prototype.name = "ArgumentOutOfRangeError";
    var jb = Pa.NotSupportedError = function(a) {
      this.message = a || "This operation is not supported", Error.call(this);
    };
    jb.prototype = Object.create(Error.prototype), jb.prototype.name = "NotSupportedError";
    var kb = Pa.NotImplementedError = function(a) {
      this.message = a || "This operation is not implemented", Error.call(this);
    };
    kb.prototype = Object.create(Error.prototype), kb.prototype.name = "NotImplementedError";
    var lb = Pa.helpers.notImplemented = function() {
      throw new kb;
    },
        mb = (Pa.helpers.notSupported = function() {
          throw new jb;
        }, "function" == typeof Symbol && Symbol.iterator || "_es6shim_iterator_");
    Oa.Set && "function" == typeof(new Oa.Set)["@@iterator"] && (mb = "@@iterator");
    var nb = Pa.doneEnumerator = {
      done: !0,
      value: a
    },
        ob = Pa.helpers.isIterable = function(b) {
          return b && b[mb] !== a;
        },
        pb = Pa.helpers.isArrayLike = function(b) {
          return b && b.length !== a;
        };
    Pa.helpers.iterator = mb;
    var qb = Pa.internals.bindCallback = function(a, b, c) {
      ...
      return function() {
        ...
        Qb = {};
    Qb[Hb] = Qb[Ib] = Qb[Jb] = Qb[Kb] = Qb[Lb] = Qb[Mb] = Qb[Nb] = Qb[Ob] = Qb[Pb] = !0, Qb[tb] = Qb[ub] = Qb[Gb] = Qb[vb] = Qb[wb] = Qb[xb] = Qb[yb] = Qb[zb] = Qb[Ab] = Qb[Bb] = Qb[Cb] = Qb[Db] = Qb[Eb] = Qb[Fb] = !1;
    var Rb = Object.prototype,
        ...
        _ = Pa.internals.isObject = function(a) {
          var b = typeof a;
        ...
        Xb = Array.isArray || function(a) {
          return n(a) && o(a.length) && Tb.call(a) === ub;
        },
        Yb = Pa.internals.isEqual = function(a, b) {
          return t(a, b);
        },
        Zb = ({}.hasOwnProperty, Array.prototype.slice, Pa.internals.inherits = function(a, b) {
          function c() {
            this.constructor = a;
          }
          c.prototype = b.prototype, a.prototype = new c;
        }),
        $b = Pa.internals.addProperties = function(a) {
          for (var b = [],
              c = 1,
        ...
        _b = Pa.internals.addRef = function(a, b) {
          return new vg(function(c) {
            return new mc(b.getDisposable(), a.subscribe(c));
          });
        };
    ...
    var ac = Pa.internals.PriorityQueue = function(a) {
    ...
    bc.isHigherPriority = function(a, b) {
      ...
      var b = this.length++;
      this.items[b] = new v(ac.count++, a), this.percolate(b);
    ...
    var cc = Pa.CompositeDisposable = function() {
      var a,
          b,
          c = [];
    ...
    var ec = Pa.Disposable = function(a) {
    ...
    var fc = ec.create = function(a) {
      return new ec(a);
        ...
        gc = ec.empty = {dispose: Qa},
        hc = ec.isDisposable = function(a) {
        ...
        jc = ec._fixup = function(a) {
          return hc(a) ? a : gc;
        },
        kc = Pa.SingleAssignmentDisposable = function() {
          this.isDisposed = !1, this.current = null;
        };
    kc.prototype.getDisposable = function() {
      return this.current;
    }, kc.prototype.setDisposable = function(a) {
      if (this.current)
    ...
    var lc = Pa.SerialDisposable = function() {
      this.isDisposed = !1, this.current = null;
    };
    lc.prototype.getDisposable = function() {
      return this.current;
    }, lc.prototype.setDisposable = function(a) {
      var b = this.isDisposed;
      if (!b) {
        var c = this.current;
        this.current = a;
    ...
    var mc = Pa.BinaryDisposable = function(a, b) {
    ...
    var nc = Pa.NAryDisposable = function(a) {
    ...
    var oc = Pa.RefCountDisposable = function() {
      function a(a) {
    ...
    var pc = Pa.internals.ScheduledItem = function(a, b, c, d, e) {
      this.scheduler = a, this.state = b, this.action = c, this.dueTime = d, this.comparer = e || Ua, this.disposable = new kc;
    };
    pc.prototype.invoke = function() {
      this.disposable.setDisposable(this.invokeCore());
    }, pc.prototype.compareTo = function(a) {
      return this.comparer(this.dueTime, a.dueTime);
    }, pc.prototype.isCancelled = function() {
      return this.disposable.isDisposed;
    }, pc.prototype.invokeCore = function() {
      return jc(this.action(this.scheduler, this.state));
    };
    var qc = Pa.Scheduler = function() {
      function a() {}
    ...
    !function(a) {
      function b(a, b) {
        function c(b) {
          function d(a, b) {
            return g ? f.remove(i) : h = !0, e(b, c), gc;
          }
          var g = !1,
              h = !1,
              i = a.schedule(b, d);
      ...
      function c(a, b) {
        function c(b, d) {
          function g(a, b) {
            return h ? f.remove(j) : i = !0, e(b, c), gc;
          }
          var h = !1,
              i = !1,
    ...
    var tc,
        uc,
        vc = Pa.internals.SchedulePeriodicRecursive = function() {
          function a(a) {
            return function(b, c) {
              c(0, a._period);
        ...
        wc = function(a) {
          ...
          return Zb(b, a), b.prototype.schedule = function(a, b) {
            return jc(b(this, a));
          }, b;
        }(qc),
        xc = qc.immediate = new wc,
        yc = function(a) {
          function b() {
            for (; d.length > 0; ) {
              var a = d.dequeue();
          ...
          var d;
          return Zb(c, a), c.prototype.schedule = function(a, c) {
            var f = new pc(this, a, c, this.now());
            if (d)
              d.enqueue(f);
            else {
              d = new ac(4), d.enqueue(f);
              var g = Za(b)();
              d = null, g === Ya && e(g.e);
            }
            return f.disposable;
    ...
    !function() {
      ...
      if (Xa(h))
        ...
        Oa.addEventListener("message", j, !1), tc = function(a) {
          var b = c++;
        ...
        tc = "document" in Oa && "onreadystatechange" in Oa.document.createElement("script") ? function(b) {
    ...
    var Dc = function(a) {
      ...
      function c(a, b, c, d) {
        return function() {
          a.setDisposable(ec._fixup(b(c, d)));
        };
      }
      function d(a) {
      ...
      return Zb(b, a), d.prototype.dispose = function() {
        this.isDisposed || (this.isDisposed = !0, uc(this._id));
      }, e.prototype.dispose = function() {
        this.isDisposed || (this.isDisposed = !0, Cc(this._id));
      }, b.prototype.schedule = function(a, b) {
        var e = new kc,
            f = tc(c(e, b, this, a));
        return new mc(e, new d(f));
      }, b.prototype._scheduleFuture = function(a, b, d) {
        if (0 === b)
          return this.schedule(a, d);
        var f = new kc,
            g = Bc(c(f, d, this, a), b);
        return new mc(f, new e(g));
      }, b;
    }(qc),
        Ec = qc["default"] = qc.async = new Dc,
        Fc = function(a) {
          function b(b, c) {
          ...
          return Zb(b, a), b.prototype.schedule = function(a, b) {
            ...
            return function(c, d) {
              ...
              return f === Ya ? (b._handler(f.e) || e(f.e), gc) : jc(f);
            };
        ...
        Gc = Pa.Notification = function() {
          ...
          return a.prototype._accept = function(a, b, c) {
            ...
            var b = this;
            return sc(a) || (a = xc), new vg(function(c) {
        ...
        Hc = function(a) {
          ...
          return Zb(b, a), b.prototype._accept = function(a) {
            return a(this.value);
        ...
        Ic = function(a) {
          ...
          return Zb(b, a), b.prototype._accept = function(a, b) {
            return b(this.error);
          }, b.prototype._acceptObserver = function(a) {
        ...
        Jc = function(a) {
          ...
          return Zb(b, a), b.prototype._accept = function(a, b, c) {
            return c();
          }, b.prototype._acceptObserver = function(a) {
            return a.onCompleted();
          }, b.prototype.toString = function() {
        ...
        Kc = Gc.createOnNext = function(a) {
          return new Hc(a);
        },
        Lc = Gc.createOnError = function(a) {
          return new Ic(a);
        },
        Mc = Gc.createOnCompleted = function() {
          return new Jc;
        },
        Nc = Pa.Observer = function() {};
    ...
    var Oc = Nc.create = function(a, b, c) {
      return a || (a = Qa), b || (b = Va), c || (c = Qa), new Rc(a, b, c);
    };
    Nc.fromNotifier = function(a, b) {
      var c = qb(a, b, 1);
      return new Rc(function(a) {
        return c(Kc(a));
      }, function(a) {
        return c(Lc(a));
      }, function() {
    ...
    var Pc,
        Qc = Pa.internals.AbstractObserver = function(a) {
          function b() {
            this.isStopped = !1;
          }
          return Zb(b, a), b.prototype.next = lb, b.prototype.error = lb, b.prototype.completed = lb, b.prototype.onNext = function(a) {
        ...
        Rc = Pa.AnonymousObserver = function(a) {
          function b(b, c, d) {
            a.call(this), this._onNext = b, this._onError = c, this._onCompleted = d;
          }
          return Zb(b, a), b.prototype.next = function(a) {
            this._onNext(a);
        ...
        Tc = Pa.internals.ScheduledObserver = function(a) {
          function b(b, c) {
            a.call(this), this.scheduler = b, this.observer = c, this.isAcquired = !1, this.hasFaulted = !1, this.queue = [], this.disposable = new lc;
          }
          function c(a, b) {
            return function() {
              a.onNext(b);
        ...
        Uc = function(a) {
          ...
          return Zb(b, a), b.prototype.next = function(b) {
        ...
        Vc = Pa.Observable = function() {
          ...
          return Pc = b.prototype, b.isObservable = function(a) {
            return a && Xa(a.subscribe);
          }, Pc.subscribe = Pc.forEach = function(a, b, c) {
        ...
        Wc = Pa.ObservableBase = function(a) {
          function b(a) {
            return a && Xa(a.dispose) ? a : Xa(a) ? fc(a) : gc;
          }
          function c(a, c) {
            var d = c[0],
                f = c[1],
          ...
          return Zb(d, a), d.prototype._subscribe = function(a) {
            var b = new wg(a),
                d = [b, this];
            return zc.scheduleRequired() ? zc.schedule(d, c) : c(null, d), b;
          }, d.prototype.subscribeCore = lb, d;
        }(Vc),
        Xc = Pa.FlatMapObservable = function(a) {
          function b(b, c, d, e) {
            this.resultSelector = Xa(d) ? d : null, this.selector = qb(Xa(c) ? c : function() {
              return c;
            }, e, 3), this.source = b, a.call(this);
          }
          function c(a, b, c, d) {
            this.i = 0, this.selector = b, this.resultSelector = c, this.source = d, this.o = a, Qc.call(this);
          }
          return Zb(b, a), b.prototype.subscribeCore = function(a) {
            return this.source.subscribe(new c(a, this.selector, this.resultSelector, this));
          }, Zb(c, Qc), c.prototype._wrapResult = function(a, b, c) {
            ...
            return c === Ya ? this.o.onError(c.e) : (Wa(c) && (c = gd(c)), (pb(c) || ob(c)) && (c = Vc.from(c)), void this.o.onNext(this._wrapResult(c, a, b)));
        ...
        Yc = Pa.internals.Enumerable = function() {};
    ...
    var Zc = function(a) {
      ...
      function d(a, b) {
        this._state = a, this._recurse = b, Qc.call(this);
      }
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new lc,
            d = {
            ...
            e = zc.scheduleRecursive(d, c);
        return new nc([b, e, new y(d)]);
      }, Zb(d, Qc), d.prototype.next = function(a) {
    ...
    Yc.prototype.catchError = function() {
      return new $c(this);
    }, Yc.prototype.catchErrorWhen = function(a) {
      var b = this;
      return new vg(function(c) {
        var d,
            e = new zg,
            ...
            j = {isDisposed: !1},
            k = new lc,
            l = zc.scheduleRecursive(null, function(a, b) {
              if (!j.isDisposed) {
                ...
                var l = new kc,
                    m = new kc;
                k.setDisposable(new mc(m, l)), l.setDisposable(h.subscribe(function(a) {
                  c.onNext(a);
                }, function(a) {
    ...
    var _c = function(a) {
      ...
      return Zb(b, a), b.prototype[mb] = function() {
        return new c(this);
      }, c.prototype.next = function() {
        return 0 === this.l ? nb : (this.l > 0 && this.l--, {
          done: !1,
          value: this.v
        });
      }, b;
    }(Yc),
        ad = Yc.repeat = function(a, b) {
          return new _c(a, b);
        },
        bd = function(a) {
          function b(a, b, c) {
            this.s = a, this.fn = b ? qb(b, c, 3) : null;
          }
          function c(a) {
        ...
        dd = function(a) {
          ...
          return Zb(b, a), b.prototype.subscribeCore = function(a) {
            return this.source.subscribe(new Uc(this._s, a));
          }, b;
        }(Wc);
    ...
    var fd = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        gd = Vc.fromPromise = function(a, b) {
          return b || (b = Ec), new fd(a, b);
        };
    Pc.toPromise = function(a) {
      if (a || (a = Pa.config.Promise), !a)
        throw new jb("Promise type not provided nor in Rx.config.Promise");
      var b = this;
    ...
    var hd = function(a) {
      ...
      function c(a) {
        this.o = a, this.a = [], Qc.call(this);
      }
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new c(a));
      }, Zb(c, Qc), c.prototype.next = function(a) {
        this.a.push(a);
      }, c.prototype.error = function(a) {
        this.o.onError(a);
      }, c.prototype.completed = function() {
    ...
    var id = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        var b = Za(this._f)();
        return b === Ya ? Bd(b.e).subscribe(a) : (Wa(b) && (b = gd(b)), b.subscribe(a));
      }, b;
    }(Wc),
        jd = Vc.defer = function(a) {
          return new id(a);
        },
        kd = function(a) {
          function b(b) {
          ...
          return Zb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            var a = this.observer;
            return this.scheduler === xc ? d(null, a) : this.scheduler.schedule(a, d);
          }, b;
        }(Wc),
        ld = new kd(xc),
        md = Vc.empty = function(a) {
          return sc(a) || (a = xc), a === xc ? ld : new kd(a);
        },
        nd = function(a) {
          function b(b, c, d) {
    ...
    var pd = Vc.from = function(a, b, c, d) {
      if (null == a)
      ...
      return sc(d) || (d = zc), new nd(a, e, d);
        ...
        rd = Vc.fromArray = function(a, b) {
          return sc(b) || (b = zc), new qd(a, b);
        },
        sd = function(a) {
    ...
    Vc.generate = function(a, b, c, d, e) {
      return sc(e) || (e = zc), new sd(a, b, c, d, e);
    }, Vc.of = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
    ...
    var zd = function(a) {
      ...
      function c(a, b) {
        var c = b[0],
            d = b[1];
        return d.onNext(c), d.onCompleted(), gc;
      }
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        var b = [this._value, a];
        return this._scheduler === xc ? c(null, b) : this._scheduler.schedule(b, c);
      }, b;
    }(Wc),
        Ad = (Vc["return"] = Vc.just = function(a, b) {
          return sc(b) || (b = xc), new zd(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        Bd = Vc["throw"] = function(a, b) {
          return sc(b) || (b = xc), new Ad(a, b);
        },
        Cd = function(a) {
          function b(b, c) {
          ...
          return Zb(b, a), b.prototype.subscribeCore = function(a) {
            var b = gc,
                c = Za(this._resFn)();
            if (c === Ya)
              return new mc(Bd(c.e).subscribe(a), b);
            c && (b = c);
            var d = Za(this._obsFn)(c);
            return d === Ya ? new mc(Bd(d.e).subscribe(a), b) : new mc(d.subscribe(a), b);
          }, b;
        }(Wc);
    Vc.using = function(a, b) {
      ...
      return new vg(function(c) {
        ...
        return i.setDisposable(b.subscribe(k)), j.setDisposable(a.subscribe(l)), new mc(i, j);
      });
    }, Vc.amb = function() {
      var a,
          b = vd();
    ...
    var Dd = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new kc,
            c = new lc;
        return c.setDisposable(b), b.setDisposable(this.source.subscribe(new Ed(a, c, this._fn))), c;
      }, b;
    }(Wc),
        Ed = function(a) {
          function b(b, c, d) {
    ...
    Pc["catch"] = function(a) {
      return Xa(a) ? new Dd(this, a) : Fd([this, a]);
    };
    var Fd = Vc["catch"] = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
    ...
    Pc.combineLatest = function() {
      for (var a = arguments.length,
          ...
          c = 0; a > c; c++)
        b[c] = arguments[c];
      return Array.isArray(b[0]) ? b[0].unshift(this) : b.unshift(this), Id.apply(this, b);
    };
    var Gd = function(a) {
      function b(b, c) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        for (var b = this._params.length,
          ...
          var f = this._params[e],
              g = new kc;
          c[e] = g, Wa(f) && (f = gd(f)), g.setDisposable(f.subscribe(new Hd(a, e, this._cb, d)));
        }
        return new nc(c);
      }, b;
    }(Wc),
        ...
        Id = Vc.combineLatest = function() {
          for (var a = arguments.length,
              b = new Array(a),
              c = 0; a > c; c++)
            b[c] = arguments[c];
          var d = Xa(b[a - 1]) ? b.pop() : L;
          return Array.isArray(b[0]) && (b = b[0]), new Gd(b, d);
        };
    Pc.concat = function() {
      for (var a = [],
          b = 0,
        ...
        Kd = function(a) {
          ...
          function c(a, b) {
            if (!a.disposable.isDisposed) {
              ...
              Wa(c) && (c = gd(c));
              var d = new kc;
              a.subscription.setDisposable(d), d.setDisposable(c.subscribe(new Jd(a, b)));
            }
          }
          return Zb(b, a), b.prototype.subscribeCore = function(a) {
            var b = new lc,
                ...
                f = xc.scheduleRecursive(e, c);
            return new nc([b, d, f]);
          }, b;
        }(Wc),
        Ld = Vc.concat = function() {
          var a;
          if (Array.isArray(arguments[0]))
            a = arguments[0];
          else {
    ...
    var Md = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Nd = function(a) {
          ...
          return Zb(b, a), b.prototype.handleSubscribe = function(a) {
            var b = new kc;
            this.g.add(b), Wa(a) && (a = gd(a)), b.setDisposable(a.subscribe(new c(this, b)));
          ...
          }, Zb(c, a), c.prototype.next = function(a) {
      ...
      return Array.isArray(c[0]) && (c = c[0]), H(a, c).mergeAll();
        ...
        Pd = function(a) {
          ...
          return Zb(b, a), b.prototype.subscribeCore = function(a) {
            var b = new cc,
                c = new kc;
            return b.add(c), c.setDisposable(this.source.subscribe(new Qd(a, b))), b;
          }, b;
        }(Wc),
        Qd = function(a) {
          function b(b, c) {
    ...
    var Rd = Pa.CompositeError = function(a) {
      this.innerErrors = a, this.message = "This contains multiple errors. Check the innerErrors", Error.call(this);
    };
    Rd.prototype = Object.create(Error.prototype), Rd.prototype.name = "CompositeError";
    var Sd = function(a) {
      function b(b) {
        this.source = b, a.call(this);
      }
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        return b.add(c), c.setDisposable(this.source.subscribe(new Td(b, d))), b;
      }, b;
    }(Wc),
        Td = function(a) {
          function b(b, c) {
          ...
          function c(a, b) {
            0 === b.length ? a.onCompleted() : 1 === b.length ? a.onError(b[0]) : a.onError(new Rd(b));
          }
          function d(b, c, d) {
          ...
          return Zb(b, a), b.prototype.next = function(a) {
            var b = new kc;
            this._group.add(b), Wa(a) && (a = gd(a)), b.setDisposable(a.subscribe(new d(b, this._group, this._state)));
          }, b.prototype.error = function(a) {
          ...
          }, Zb(d, a), d.prototype.next = function(a) {
            this._state.o.onNext(a);
          }, d.prototype.error = function(a) {
    ...
    var Ud = function(a) {
      ...
      function c(a, b) {
        if (a.pos < a.sources.length) {
          ...
          Wa(c) && (c = gd(c));
          var d = new kc;
          a.subscription.setDisposable(d), d.setDisposable(c.subscribe(new Vd(a, b)));
        } else
          a.o.onCompleted();
      }
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Wd = Vc.onErrorResumeNext = function() {
          var a = [];
          if (Array.isArray(arguments[0]))
            a = arguments[0];
          else {
        ...
        Xd = function(a) {
          function b(b, c) {
            this._s = b, this._o = Wa(c) ? gd(c) : c, this._open = !1, a.call(this);
          }
          return Zb(b, a), b.prototype.subscribeCore = function(a) {
            var b = new kc;
            b.setDisposable(this._s.subscribe(new Yd(a, this))), Wa(this._o) && (this._o = gd(this._o));
            var c = new kc;
            return c.setDisposable(this._o.subscribe(new Zd(a, this, c))), new mc(b, c);
          }, b;
        }(Wc),
        Yd = function(a) {
          function b(b, c) {
        ...
        Zd = function(a) {
          ...
          return Zb(b, a), b.prototype.next = function() {
    ...
    var $d = function(a) {
      ...
      function c(a, b) {
        this.o = a, this.inner = b, this.stopped = !1, this.latest = 0, this.hasLatest = !1, Qc.call(this);
      }
      function d(a, b) {
        this.parent = a, this.id = b, Qc.call(this);
      }
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new lc,
        ...
        var b = new kc,
            c = ++this.latest;
        this.hasLatest = !0, this.inner.setDisposable(b), Wa(a) && (a = gd(a)), b.setDisposable(a.subscribe(new d(this, c)));
      }, c.prototype.error = function(a) {
        this.o.onError(a);
      }, c.prototype.completed = function() {
    ...
    var _d = function(a) {
      function b(b, c) {
        this.source = b, this.other = Wa(c) ? gd(c) : c, a.call(this);
      }
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return new mc(this.source.subscribe(a), this.other.subscribe(new ae(a)));
      }, b;
    }(Wc),
        ae = function(a) {
          function b(b) {
    ...
    var be = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        for (var b = this._ss.length,
          ...
          var g = this._ss[f],
              h = new kc;
          Wa(g) && (g = gd(g)), h.setDisposable(g.subscribe(new ce(a, f, c))), e[f] = h;
        }
        var i = new kc;
        return i.setDisposable(this._s.subscribe(new de(a, this._cb, c))), e[d] = i, new nc(e);
      }, b;
    }(Wc),
        ce = function(a) {
          function b(b, c, d) {
    ...
    Pc.withLatestFrom = function() {
      ...
      for (var a = arguments.length,
        ...
        b[c] = arguments[c];
      var d = Xa(b[a - 1]) ? b.pop() : L;
      return Array.isArray(b[0]) && (b = b[0]), new be(this, b, d);
    };
    var ee = function(a) {
      function b(b, c) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        for (var b = this._s.length,
          ...
          var g = this._s[f],
              h = new kc;
          c[f] = h, Wa(g) && (g = gd(g)), h.setDisposable(g.subscribe(new fe(a, f, this, e, d)));
        }
        return new nc(c);
      }, b;
    }(Wc),
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        for (var b = this.sources,
          ...
          !function(a) {
            var c = b[a],
                f = new kc;
            (pb(c) || ob(c)) && (c = pd(c)), d[a] = f, f.setDisposable(c.subscribe(new he(e, a)));
          }(f);
        return new nc(d);
      }, b;
    }(Wc),
    ...
    Pc.zipIterable = function() {
      ...
      var d = Xa(b[a - 1]) ? b.pop() : L,
          e = this;
      return b.unshift(e), new ge(b, d);
    }, Pc.asObservable = function() {
      return new vg(N(this), this);
    ...
    var ie = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new je(a));
      }, b;
    }(Wc),
        je = function(a) {
          function b(b) {
    ...
    var ke = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new le(a, this.keyFn, this.comparer));
      }, b;
    }(Wc),
        le = function(a) {
          function b(b, c, d) {
    ...
    var me = function(a) {
      ...
      function c(a, b) {
        this.o = a, this.t = !b._oN || Xa(b._oN) ? Oc(b._oN || Qa, b._oE || Qa, b._oC || Qa) : b._oN, this.isStopped = !1, Qc.call(this);
      }
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
    ...
    var ne = function(a) {
      function b(b, c, d) {
        this.source = b, this._fn = qb(c, d, 0), a.call(this);
      }
      function c(a, b) {
    ...
    var pe = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new qe(a));
      }, b;
    }(Wc),
        qe = function(a) {
          function b(b) {
          ...
          return Zb(b, a), b.prototype.next = function(a) {
            ...
            this._o.onNext(Lc(a)), this._o.onCompleted();
          }, b.prototype.completed = function() {
            this._o.onNext(Mc()), this._o.onCompleted();
          }, b;
        }(Qc);
    Pc.materialize = function() {
      return new pe(this);
    }, Pc.repeat = function(a) {
      return ad(this, a).concat();
    }, Pc.retry = function(a) {
      return ad(this, a).catchError();
    }, Pc.retryWhen = function(a) {
      return ad(this).catchErrorWhen(a);
    };
    var re = function(a) {
      function b(b, c, d, e) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new se(a, this));
      }, b;
    }(Wc),
        se = function(a) {
          function b(b, c) {
    ...
    Pc.scan = function() {
      var a,
          b = !1,
          c = arguments[0];
      return 2 === arguments.length && (b = !0, a = arguments[1]), new re(this, c, b, a);
    };
    var te = function(a) {
      function b(b, c) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new ue(a, this._c));
      }, b;
    }(Wc),
        ue = function(a) {
          function b(b, c) {
    ...
    Pc.skipLast = function(a) {
      ...
      var a,
          b = 0;
      arguments.length && sc(arguments[0]) ? (a = arguments[0], b = 1) : a = xc;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return cd([rd(c, a), this]).concat();
    };
    var ve = function(a) {
      function b(b, c) {
        this._o = b, this._c = c, this._q = [], a.call(this);
    ...
    }, Pc.flatMapConcat = Pc.concatMap = function(a, b, c) {
      return new Xc(this, a, b, c).merge(1);
    }, Pc.concatMapObserver = Pc.selectConcatObserver = function(a, b, c, d) {
      var e = this,
          f = qb(a, d, 2),
          g = qb(b, d, 1),
          h = qb(c, d, 0);
      return new vg(function(a) {
        var b = 0;
        return e.subscribe(function(c) {
          ...
          Wa(c) && (c = gd(c)), a.onNext(c), a.onCompleted();
        }, function() {
          var b;
          try {
            b = h();
          ...
          Wa(b) && (b = gd(b)), a.onNext(b), a.onCompleted();
        });
      }, this).concatAll();
    };
    var xe = function(a) {
    ...
    Pc.defaultIfEmpty = function(b) {
      var c = this;
      return b === a && (b = null), new vg(function(a) {
        return c.subscribe(new xe(a, b));
      }, c);
    ...
    var ye = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new ze(a, this._keyFn, this._cmpFn));
      }, b;
    }(Wc),
        ze = function(a) {
          function b(b, c, d) {
    ...
    Pc.distinct = function(a, b) {
      return b || (b = Ta), new ye(this, a, b);
    }, Pc.groupBy = function(a, b) {
      return this.groupByUntil(a, b, vd);
    }, Pc.groupByUntil = function(b, c, d) {
      var e = this;
      return new vg(function(f) {
        var g = new Pf,
            h = new cc,
            i = new oc(h),
            j = function(a) {
        ...
        return h.add(e.subscribe(function(e) {
          ...
          var l = !1,
              m = g.get(k);
          if (m === a && (m = new zg, g.set(k, m), l = !0), l) {
            var n = new yg(k, m, i),
                o = new yg(k, m),
                p = Za(d)(o);
            if (p === Ya)
    ...
    var Ae = function(a) {
      function b(b, c, d) {
        this.source = b, this.selector = qb(c, d, 3), a.call(this);
      }
      function c(a, b) {
        return function(c, d, e) {
      ...
      function d(a, b, c) {
        this.o = a, this.selector = b, this.source = c, this.i = 0, Qc.call(this);
      }
      return Zb(b, a), b.prototype.internalMap = function(a, d) {
    ...
    Pc.map = Pc.select = function(a, b) {
      ...
      return this instanceof Ae ? this.internalMap(c, b) : new Ae(this, c, b);
    }, Pc.pluck = function() {
    ...
    }, Pc.flatMap = Pc.selectMany = function(a, b, c) {
      return new Xc(this, a, b, c).mergeAll();
      ...
      return new vg(function(f) {
        ...
        return e.subscribe(function(b) {
          ...
          Wa(c) && (c = gd(c)), f.onNext(c), f.onCompleted();
        }, function() {
          var a;
          try {
            a = c.call(d);
          ...
          Wa(a) && (a = gd(a)), f.onNext(a), f.onCompleted();
        });
      }, e).mergeAll();
    }, Pa.Observable.prototype.flatMapLatest = function(a, b, c) {
      return new Xc(this, a, b, c).switchLatest();
    };
    var Be = function(a) {
      function b(b, c) {
      ...
      function c(a, b) {
        this._o = a, this._r = b, Qc.call(this);
      }
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
    ...
    var Ce = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new De(a, this));
      }, b;
    }(Wc),
        De = function(a) {
          function b(b, c) {
    ...
    var Ee = function(a) {
      ...
      function c(a, b) {
        this._o = a, this._c = b, this._r = b, Qc.call(this);
      }
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new c(a, this._count));
      }, Zb(c, Qc), c.prototype.next = function(a) {
    ...
    var He = function(a) {
      function b(b, c, d) {
        this.source = b, this.predicate = qb(c, d, 3), a.call(this);
      }
      function c(a, b) {
        return function(c, d, e) {
      ...
      function d(a, b, c) {
        this.o = a, this.predicate = b, this.source = c, this.i = 0, Qc.call(this);
      }
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
    ...
    Pc.filter = Pc.where = function(a, b) {
      return this instanceof He ? this.internalFilter(a, b) : new He(this, a, b);
    };
    var Ie = function(a) {
      function b(b, c, d) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new Je(a, this._k, this._c));
      }, b;
    }(Wc),
        Je = function(a) {
          function b(b, c, d) {
        ...
        Le = function(a) {
          ...
          return Zb(b, a), b.prototype.next = function(a) {
            ...
            this._hv && this._o.onNext(this._a), !this._hv && this._hs && this._o.onNext(this._s), !this._hv && !this._hs && this._o.onError(new gb), this._o.onCompleted();
          }, b;
        }(Qc);
    Pc.reduce = function() {
      var a,
          b = !1,
          c = arguments[0];
      return 2 === arguments.length && (b = !0, a = arguments[1]), new Ke(this, c, b, a);
    };
    var Me = function(a) {
      function b(b, c) {
        this.source = b, this._fn = c, a.call(this);
    ...
    var Oe = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new Pe(a));
      }, b;
    }(Wc),
        Pe = function(a) {
          function b(b) {
    ...
    var Se = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this._n < 0 ? (a.onNext(!1), a.onCompleted(), gc) : this.source.subscribe(new Te(a, this._elem, this._n));
      }, b;
    }(Wc),
        Te = function(a) {
          function b(b, c, d) {
    ...
    var We = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this._n < 0 ? (a.onNext(-1), a.onCompleted(), gc) : this.source.subscribe(new Xe(a, this._e, this._n));
      }, b;
    }(Wc),
        Xe = function(a) {
          function b(b, c, d) {
    ...
    Pc.indexOf = function(a, b) {
      var c = +b || 0;
      return Math.abs(c) === 1 / 0 && (c = 0), new We(this, a, c);
    };
    var Ye = function(a) {
      function b(b, c) {
        this.source = b, this._fn = c, a.call(this);
    ...
    Pc.sum = function(a, b) {
      ...
      return b || (b = Ua), new Ie(this, a, function(a, c) {
        return -1 * b(a, c);
      });
    }, Pc.min = function(a) {
    ...
    var $e = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new _e(a, this._fn, this.source));
      }, b;
    }(Wc),
        _e = function(a) {
          function b(b, c, d) {
          ...
          return Zb(b, a), b.prototype.next = function(a) {
            ...
            return 0 === this._c ? this._o.onError(new gb) : (this._o.onNext(this._t / this._c), void this._o.onCompleted());
          }, b;
        }(Qc);
    Pc.average = function(a, b) {
      var c,
          d = this;
      return Xa(a) && (c = qb(a, b, 3)), new $e(d, c);
    }, Pc.sequenceEqual = function(a, b) {
      var c = this;
      return b || (b = Ta), new vg(function(d) {
        var e = !1,
            f = !1,
            g = [],
            h = [],
    ...
    var af = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new bf(a, this._i, this._d));
      }, b;
    }(Wc),
        bf = function(b) {
          function c(a, c, d) {
          ...
          return Zb(c, b), c.prototype.next = function(a) {
            0 === this._i-- && (this._o.onNext(a), this._o.onCompleted());
          }, c.prototype.error = function(a) {
            this._o.onError(a);
          }, c.prototype.completed = function() {
            this._d === a ? this._o.onError(new ib) : (this._o.onNext(this._d), this._o.onCompleted());
          }, c;
        }(Qc);
    Pc.elementAt = function(a, b) {
      if (0 > a)
        throw new ib;
    ...
    var cf = function(b) {
      ...
      return Zb(c, b), c.prototype.next = function(a) {
        ...
        this._hv ? (this._o.onNext(this._v), this._o.onCompleted()) : this._obj.defaultValue === a ? this._o.onError(new gb) : (this._o.onNext(this._obj.defaultValue), this._o.onCompleted());
      }, c;
    }(Qc);
    Pc.single = function(a, b) {
      ...
      if (c = "object" == typeof arguments[0] ? arguments[0] : {
        ...
        var e = c.predicate;
        c.predicate = qb(e, c.thisArg, 3);
      }
      return new vg(function(a) {
        return d.subscribe(new cf(a, c, d));
      }, d);
    };
    var df = function(a) {
      function b(b, c) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new ef(a, this._obj, this.source));
      }, b;
    }(Wc),
        ef = function(b) {
          function c(a, c, d) {
          ...
          return Zb(c, b), c.prototype.next = function(a) {
            ...
            this._obj.defaultValue === a ? this._o.onError(new gb) : (this._o.onNext(this._obj.defaultValue), this._o.onCompleted());
          }, c;
        }(Qc);
    Pc.first = function() {
      var a = {};
    ...
    var ff = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new gf(a, this._obj, this.source));
      }, b;
    }(Wc),
        gf = function(b) {
          function c(a, c, d) {
    ...
    var jf = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new kf(a));
      }, b;
    }(Wc),
        kf = function(a) {
          function b(b) {
    ...
    var lf = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new mf(a, this._k, this._e));
      }, b;
    }(Wc),
        mf = function(a) {
          function b(b, c, d) {
    ...
    var nf = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new of(a, this._b, this._e));
      }, b;
    }(Wc),
        of = function(a) {
          function b(b, c, d) {
    ...
    var pf = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this._n < 0 ? (a.onNext(-1), a.onCompleted(), gc) : this.source.subscribe(new qf(a, this._e, this._n));
      }, b;
    }(Wc),
        qf = function(a) {
          function b(b, c, d) {
    ...
    Pc.lastIndexOf = function(a, b) {
      var c = +b || 0;
      return Math.abs(c) === 1 / 0 && (c = 0), new pf(this, a, c);
    }, Vc.wrap = function(a) {
      function b() {
        return Vc.spawn.call(this, a.apply(this, arguments));
      }
      return b.__generatorFunction__ = a, b;
    };
    var rf = Vc.spawn = function() {
      ...
      return new vg(function(d) {
        ...
        function g(a) {
          ...
          var c = V.call(b, a.value),
              g = null,
              i = !1;
          Vc.isObservable(c) ? h.add(c.subscribe(function(a) {
            i = !0, g = a;
          }, f, function() {
            i && e(g);
    ...
    var sf = Vc.toAsync = function(a, b, c) {
      return sc(c) || (c = Ec), function() {
        var d = arguments,
            e = new Ag;
    ...
    Vc.fromEvent = function(a, b, c) {
      return a.addListener ? vf(function(c) {
        a.addListener(b, c);
      }, function(c) {
        a.removeListener(b, c);
      }, c) : Pa.config.useNativeEvents || "function" != typeof a.on || "function" != typeof a.off ? new tf(a, b, c).publish().refCount() : vf(function(c) {
        a.on(b, c);
      }, function(c) {
        a.off(b, c);
      }, c);
    ...
    var uf = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        vf = Vc.fromEventPattern = function(a, b, c) {
          return new uf(a, b, c).publish().refCount();
        };
    Vc.startAsync = function(a) {
      var b = Za(a)();
      return b === Ya ? Bd(b.e) : gd(b);
    };
    var wf = function(a) {
      function b(b, c) {
        this.source = b, this.controller = new zg, c && c.subscribe ? this.pauser = this.controller.merge(c) : this.pauser = this.controller, a.call(this);
      }
      return Zb(b, a), b.prototype._subscribe = function(a) {
        var b = this.source.publish(),
            c = b.subscribe(a),
            d = gc,
            e = this.pauser.distinctUntilChanged().subscribe(function(a) {
              a ? d = b.connect() : (d.dispose(), d = gc);
            });
        return new nc([c, d, e]);
    ...
    var xf = function(b) {
      function c(a, c) {
        this.source = a, this.controller = new zg, c && c.subscribe ? this.pauser = this.controller.merge(c) : this.pauser = this.controller, b.call(this);
      }
      return Zb(c, b), c.prototype._subscribe = function(b) {
        function c() {
          for (; e.length > 0; )
            b.onNext(e.shift());
        }
    ...
    var yf = function(a) {
      function b(b, c, d) {
        a.call(this), this.subject = new zf(c, d), this.source = b.multicast(this.subject).refCount();
      }
      return Zb(b, a), b.prototype._subscribe = function(a) {
        ...
        zf = function(a) {
          function b(b, c) {
            null == b && (b = !0), a.call(this), this.subject = new zg, this.enableQueue = b, this.queue = b ? [] : null, this.requestedCount = 0, this.requestedDisposable = null, this.error = null, this.hasFailed = !1, this.hasCompleted = !1, this.scheduler = c || zc;
          }
          return Zb(b, a), $b(b.prototype, Nc, {
            _subscribe: function(a) {
              return this.subject.subscribe(a);
            },
            onCompleted: function() {
              this.hasCompleted = !0, this.enableQueue && 0 !== this.queue.length ? this.queue.push(Gc.createOnCompleted()) : (this.subject.onCompleted(), this.disposeCurrentRequest());
            },
            onError: function(a) {
              this.hasFailed = !0, this.error = a, this.enableQueue && 0 !== this.queue.length ? this.queue.push(Gc.createOnError(a)) : (this.subject.onError(a), this.disposeCurrentRequest());
            },
            onNext: function(a) {
              this.requestedCount <= 0 ? this.enableQueue && this.queue.push(Gc.createOnNext(a)) : (0 === this.requestedCount-- && this.disposeCurrentRequest(), this.subject.onNext(a));
            },
            ...
            request: function(a) {
              ...
              return this.requestedDisposable = this.scheduler.schedule(a, function(a, c) {
                ...
                return !e && d > 0 ? (b.requestedCount = d, fc(function() {
                  b.requestedCount = 0;
                })) : void 0;
    ...
    Pc.controlled = function(a, b) {
      return a && sc(a) && (b = a, a = !0), null == a && (a = !0), new yf(this, a, b);
    };
    var Af = function(a) {
      function b(b) {
      ...
      Zb(b, a), b.prototype._subscribe = function(a) {
        return this.subscription = this.source.subscribe(new d(a, this, this.subscription)), new mc(this.subscription, Ec.schedule(this, c));
      };
      var d = function(a) {
        function c(b, c, d) {
        ...
        return Zb(c, a), c.prototype.completed = function() {
          this.observer.onCompleted(), this.dispose();
        }, c.prototype.error = function(a) {
          this.observer.onError(a), this.dispose();
        }, c.prototype.next = function(a) {
          this.observer.onNext(a), this.scheduleDisposable = Ec.schedule(this, d);
        }, b.dispose = function() {
    ...
    yf.prototype.stopAndWait = function() {
      return new Af(this);
    };
    var Bf = function(a) {
      function b(b, c) {
      ...
      var d = function(a) {
        ...
        return Zb(b, a), b.prototype.completed = function() {
          this.observer.onCompleted(), this.dispose();
        }, b.prototype.error = function(a) {
          this.observer.onError(a), this.dispose();
        }, b.prototype.next = function(a) {
          this.observer.onNext(a), this.received = ++this.received % this.observable.windowSize, 0 === this.received && (this.scheduleDisposable = Ec.schedule(this, c));
        }, b.prototype.dispose = function() {
          this.observer = null, this.cancel && (this.cancel.dispose(), this.cancel = null), this.scheduleDisposable && (this.scheduleDisposable.dispose(), this.scheduleDisposable = null), a.prototype.dispose.call(this);
        }, b;
      }(Qc);
    ...
    yf.prototype.windowed = function(a) {
    ...
    var Cf = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        return new mc(this._fn2(b).subscribe(a), b.connect());
      }, b;
    }(Wc);
    Pc.multicast = function(a, b) {
      return Xa(a) ? new Cf(this, a, b) : new Ff(this, a);
    ...
    var Ef = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Ff = Pa.ConnectableObservable = function(a) {
          function b(b, c) {
          ...
          return Zb(b, a), c.prototype.dispose = function() {
    ...
    var Gf = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new Hf(a));
      }, b;
    }(Wc),
        Hf = function(a) {
          function b(a) {
    ...
    Pc.letBind = Pc.let = function(a) {
      return a(this);
    }, Vc["if"] = function(a, b, c) {
      return jd(function() {
        return c || (c = md()), Wa(b) && (b = gd(b)), Wa(c) && (c = gd(c)), "function" == typeof c.now && (c = md(c)), a() ? b : c;
      });
    }, Vc["for"] = Vc.forIn = function(a, b, c) {
      return cd(a, b, c).concat();
    };
    var Jf = Vc["while"] = Vc.whileDo = function(a, b) {
      return Wa(b) && (b = gd(b)), la(a, b).concat();
    };
    Pc.doWhile = function(a) {
      return Ld([this, Jf(a, this)]);
    }, Vc["case"] = function(a, b, c) {
      return jd(function() {
        Wa(c) && (c = gd(c)), c || (c = md()), sc(c) && (c = md(c));
        var d = b[a()];
        return Wa(d) && (d = gd(d)), d || c;
      });
    };
    var Kf = function(a) {
      function b(b, c, d) {
      ...
      function c(a, b) {
        ...
        c = d.q.shift();
        var f = new kc;
        d.d.add(f), f.setDisposable(c.subscribe(new Lf(d, e, f))), b([d, e]);
      }
      return Zb(b, a), b.prototype._ensureActive = function(a) {
        var b = !1;
    ...
    Pc.expand = function(a, b) {
      return sc(b) || (b = zc), new Kf(this, a, b);
    };
    var Mf = function(a) {
      function b(b, c) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        for (var b = this._sources.length,
          ...
          Wa(g) && (g = gd(g)), d.add(g.subscribe(new Nf(a, c, e, this._cb, d)));
        }
        return d;
      }, b;
    }(Wc),
    ...
    Vc.forkJoin = function() {
      for (var a = arguments.length,
        ...
        b[c] = arguments[c];
      var d = Xa(b[a - 1]) ? b.pop() : L;
      return Array.isArray(b[0]) && (b = b[0]), new Mf(b, d);
    }, Pc.forkJoin = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      return Array.isArray(b[0]) ? b[0].unshift(this) : b.unshift(this), Vc.forkJoin.apply(null, b);
    }, Pc.manySelect = Pc.extend = function(a, b) {
      sc(b) || (b = Pa.Scheduler.immediate);
      var c = this;
      return jd(function() {
        var d;
    ...
    var Of = function(a) {
      ...
      return Zb(b, a), $b(b.prototype, Nc, {
        _subscribe: function(a) {
          var b = new cc;
          return b.add(zc.schedule(this, function(c, d) {
    ...
    var Qf = function(a) {
      function b(b, c) {
        a.call(this), this.source = b, this.onError = c, this.queue = [], this.activePlans = [], this.subscription = new kc, this.isDisposed = !1;
      }
      Zb(b, a);
      var c = b.prototype;
    ...
    var Rf = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Sf = Vc.interval = function(a, b) {
          return ua(a, a, sc(b) ? b : Ec);
        };
    Vc.timer = function(b, c, d) {
      var e;
      return sc(d) || (d = Ec), null != c && "number" == typeof c ? e = c : sc(c) && (d = c), (b instanceof Date || "number" == typeof b) && e === a ? sa(b, d) : b instanceof Date && e !== a ? ta(b.getTime(), c, d) : ua(b, e, d);
    };
    Pc.delay = function() {
      var a = arguments[0];
      if ("number" == typeof a || a instanceof Date) {
        var b = a,
            c = arguments[1];
        return sc(c) || (c = Ec), b instanceof Date ? wa(this, b, c) : va(this, b, c);
      }
      if (Vc.isObservable(a) || Xa(a))
        return xa(this, a, arguments[1]);
      throw new Error("Invalid arguments");
    };
    var Tf = function(a) {
      function b(b, c, d) {
        sc(d) || (d = Ec), this.source = b, this._dt = c, this._s = d, a.call(this);
      }
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new lc;
        return new mc(this.source.subscribe(new Uf(a, this.source, this._dt, this._s, b)), b);
      }, b;
    }(Wc),
        Uf = function(a) {
          function b(b, c, d, e, f) {
    ...
    Pc.debounce = function() {
      ...
      if ("number" == typeof arguments[0])
        return new Tf(this, arguments[0], arguments[1]);
      throw new Error("Invalid arguments");
    }, Pc.windowWithTime = function(a, b, c) {
      var d,
          e = this;
      return null == b && (d = a), sc(c) || (c = Ec), "number" == typeof b ? d = b : sc(b) && (d = a, c = b), new vg(function(b) {
        function f() {
          var a = new kc,
              e = !1,
              g = !1;
        ...
        var g,
            ...
            l = new lc,
            m = 0;
        return g = new cc(l), h = new oc(g), k.push(new zg), b.onNext(_b(k[0], h)), f(), g.add(e.subscribe(function(a) {
          for (var b = 0,
              c = k.length; c > b; b++)
            k[b].onNext(a);
        }, function(a) {
      ...
      var d = this;
      return sc(c) || (c = Ec), new vg(function(e) {
        function f(b) {
          var d = new kc;
          g.setDisposable(d), d.setDisposable(c.scheduleFuture(null, a, function() {
            if (b === k) {
              j = 0;
              var a = ++k;
              l.onCompleted(), l = new zg, e.onNext(_b(l, i)), f(a);
            }
          }));
        }
        var g = new lc,
            ...
            k = 0,
            l = new zg;
        return e.onNext(_b(l, i)), f(0), h.add(d.subscribe(function(a) {
          var c = 0,
              d = !1;
          l.onNext(a), ++j === b && (d = !0, j = 0, c = ++k, l.onCompleted(), l = new zg, e.onNext(_b(l, i))), d && f(c);
        }, function(a) {
    ...
    }, Pc.bufferWithTime = function(a, b, c) {
    ...
    var Vf = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new Wf(a, this._s));
      }, b;
    }(Wc),
        Wf = function(a) {
          function b(b, c) {
    ...
    Pc.timeInterval = function(a) {
      return sc(a) || (a = Ec), new Vf(this, a);
    };
    var Xf = function(a) {
      function b(b, c) {
        this.source = b, this._s = c, a.call(this);
    ...
    Pc.timestamp = function(a) {
      return sc(a) || (a = Ec), new Xf(this, a);
    }, Pc.sample = Pc.throttleLatest = function(a, b) {
      return sc(b) || (b = Ec), "number" == typeof a ? za(this, Sf(a, b)) : za(this, a);
    };
    var Zf = Pa.TimeoutError = function(a) {
      this.message = a || "Timeout has occurred", this.name = "TimeoutError", Error.call(this);
    };
    Zf.prototype = Object.create(Error.prototype), Pc.timeout = function() {
      var a = arguments[0];
    ...
    Vc.generateWithAbsoluteTime = function(a, b, c, d, e, f) {
      return sc(f) || (f = Ec), new $f(a, b, c, d, e, f);
    };
    var _f = function(a) {
      function b(b, c, d, e, f, g) {
        this._state = b, this._cndFn = c, this._itrFn = d, this._resFn = e, this._timeFn = f, this._s = g, this._first = !0, this._hasResult = !1, a.call(this);
    ...
    Vc.generateWithRelativeTime = function(a, b, c, d, e, f) {
      return sc(f) || (f = Ec), new _f(a, b, c, d, e, f);
    };
    var ag = function(a) {
      function b(b, c, d) {
    ...
    Pc.delaySubscription = function(a, b) {
      return sc(b) || (b = Ec), new ag(this, a, b);
    };
    var bg = function(a) {
      function b(b, c, d) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new cg(a, this));
      }, b;
    }(Wc),
        cg = function(a) {
          function b(b, c) {
    ...
    Pc.skipLastWithTime = function(a, b) {
      return sc(b) || (b = Ec), new bg(this, a, b);
    };
    var dg = function(a) {
      function b(b, c, d) {
        this.source = b, this._d = c, this._s = d, a.call(this);
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new eg(a, this._d, this._s));
      }, b;
    }(Wc),
        eg = function(a) {
          function b(b, c, d) {
    ...
    Pc.takeLastWithTime = function(a, b) {
      return sc(b) || (b = Ec), new dg(this, a, b);
    }, Pc.takeLastBufferWithTime = function(a, b) {
      var c = this;
      return sc(b) || (b = Ec), new vg(function(d) {
        var e = [];
    ...
    var fg = function(a) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return new mc(this._s.scheduleFuture(a, this._d, c), this.source.subscribe(a));
      }, b;
    }(Wc);
    Pc.takeWithTime = function(a, b) {
      return sc(b) || (b = Ec), new fg(this, a, b);
    };
    var gg = function(a) {
      function b(b, c, d) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return new mc(this._s.scheduleFuture(this, this._d, c), this.source.subscribe(new hg(a, this)));
      }, b;
    }(Wc),
        hg = function(a) {
          function b(b, c) {
    ...
    Pc.skipWithTime = function(a, b) {
      return sc(b) || (b = Ec), new gg(this, a, b);
    };
    var ig = function(a) {
      function b(b, c, d) {
      ...
      return Zb(b, a), b.prototype.subscribeCore = function(a) {
        return this._open = !1, new mc(this._s.scheduleFuture(this, this._st, c), this.source.subscribe(new jg(a, this)));
      }, b;
    }(Wc),
        jg = function(a) {
          function b(b, c) {
    ...
    Pc.skipUntilWithTime = function(a, b) {
      return sc(b) || (b = Ec), new ig(this, a, b);
    }, Pc.takeUntilWithTime = function(a, b) {
      sc(b) || (b = Ec);
      var c = this;
      return new vg(function(d) {
        return new mc(b.scheduleFuture(d, a, function(a, b) {
          b.onCompleted();
        }), c.subscribe(d));
      }, c);
        ...
        lg = function(a) {
          ...
          return Zb(b, a), b.prototype.next = function(a) {
            if (!this._s.hasCurrent) {
              this._s.hasCurrent = !0, Wa(a) && (a = gd(a));
              var b = new kc;
    ...
    Pc.switchFirst = function() {
      return new kg(this);
    }, Pc.flatMapFirst = Pc.selectManyFirst = function(a, b, c) {
      return new Xc(this, a, b, c).switchFirst();
    }, Pa.Observable.prototype.flatMapWithMaxConcurrent = function(a, b, c, d) {
      return new Xc(this, b, c, d).merge(a);
    };
    var mg = function(a) {
      function b(b, c) {
    ...
    var ng = Pa.VirtualTimeScheduler = function(a) {
      function b(b, c) {
        this.clock = b, this.comparer = c, this.isEnabled = !1, this.queue = new ac(1024), a.call(this);
      }
      Zb(b, a);
      var c = b.prototype;
      return c.now = function() {
      ...
      }, c.add = lb, c.toAbsoluteTime = lb, c.toRelativeTime = lb, c.schedulePeriodic = function(a, b, c) {
        var d = new vc(this, a, b, c);
        return d.start();
        ...
        var e = this,
            f = new pc(this, a, d, b, this.comparer);
    ...
    var og = Pa.ReactiveTest = {
      created: 100,
      subscribed: 200,
      disposed: 1e3,
      onNext: function(a, b) {
        return "function" == typeof b ? new pg(a, new Da(b)) : new pg(a, Gc.createOnNext(b));
      },
      onError: function(a, b) {
        return "function" == typeof b ? new pg(a, new Ea(b)) : new pg(a, Gc.createOnError(b));
      },
      onCompleted: function(a) {
        return new pg(a, Gc.createOnCompleted());
      },
      subscribe: function(a, b) {
        return new qg(a, b);
      }
    },
        pg = Pa.Recorded = function(a, b, c) {
    ...
    var qg = Pa.Subscription = function(a, b) {
    ...
    var rg = Pa.MockDisposable = function(a) {
    ...
    var sg = function(a) {
      ...
      var c = b.prototype;
      return c.onNext = function(a) {
        this.messages.push(new pg(this.scheduler.clock, Gc.createOnNext(a)));
      }, c.onError = function(a) {
        this.messages.push(new pg(this.scheduler.clock, Gc.createOnError(a)));
      }, c.onCompleted = function() {
        this.messages.push(new pg(this.scheduler.clock, Gc.createOnCompleted()));
      }, b;
    }(Nc);
    Fa.prototype.then = function(b, c) {
      var d = this;
      this.subscriptions.push(new qg(this.scheduler.clock));
      var e,
          ...
          g = Pa.Observer.create(function(c) {
            ...
            d.observers.splice(j, 1), d.subscriptions[f] = new qg(d.subscriptions[f].subscribe, d.scheduler.clock);
          }, function(a) {
            c(a);
            var b = d.observers.indexOf(g);
            d.observers.splice(b, 1), d.subscriptions[f] = new qg(d.subscriptions[f].subscribe, d.scheduler.clock);
          });
    ...
    var tg = function(a) {
      ...
      return Zb(b, a), b.prototype._subscribe = function(a) {
        var b = this;
        this.observers.push(a), this.subscriptions.push(new qg(this.scheduler.clock));
        var c = this.subscriptions.length - 1;
        return fc(function() {
          var d = b.observers.indexOf(a);
          b.observers.splice(d, 1), b.subscriptions[c] = new qg(b.subscriptions[c].subscribe, b.scheduler.clock);
        });
      }, b;
    }(Vc),
        ug = function(a) {
            ...
            for (var e = this.subscriptions.length - 1,
              ...
              b = this.messages[g], c = b.value, function(c) {
                f.add(d.scheduler.scheduleRelative(null, b.time, function() {
                  return c.accept(a), gc;
                }));
              }(c);
            return fc(function() {
              d.subscriptions[e] = new qg(d.subscriptions[e].subscribe, d.scheduler.clock), f.dispose();
            });
          }, b;
        }(Vc);
    Pa.TestScheduler = function(a) {
      ...
      return Zb(c, a), c.prototype.scheduleAbsolute = function(b, c, d) {
        ...
        b || (b = {}), null == b.created && (b.created = og.created), null == b.subscribed && (b.subscribed = og.subscribed), null == b.disposed && (b.disposed = og.disposed);
        var c,
            d,
    ...
    var vg = Pa.AnonymousObservable = function(a) {
      function b(a) {
        return a && Xa(a.dispose) ? a : Xa(a) ? fc(a) : gc;
      }
      function c(a, c) {
      ...
      return Zb(d, a), d.prototype._subscribe = function(a) {
        ...
        wg = function(a) {
          function b(b) {
            a.call(this), this.observer = b, this.m = new kc;
          }
          Zb(b, a);
          var c = b.prototype;
          return c.next = function(a) {
        ...
        xg = function(a) {
          ...
          return Zb(b, a), b.prototype.subscribeCore = function(a) {
            return new mc(this._m.getDisposable(), this._u.subscribe(a));
          }, b;
        }(Wc),
        yg = function(a) {
          function b(b, c, d) {
            a.call(this), this.key = b, this.underlyingObservable = d ? new xg(d, c) : c;
          }
          return Zb(b, a), b.prototype._subscribe = function(a) {
            return this.underlyingObservable.subscribe(a);
          }, b;
        }(Vc),
        zg = Pa.Subject = function(a) {
          function b() {
            a.call(this), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
          }
          return Zb(b, a), $b(b.prototype, Nc.prototype, {
            _subscribe: function(a) {
              return ic(this), this.isStopped ? this.hasError ? (a.onError(this.error), gc) : (a.onCompleted(), gc) : (this.observers.push(a), new Df(this, a));
            },
        ...
        Ag = Pa.AsyncSubject = function(a) {
          function b() {
            a.call(this), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return Zb(b, a), $b(b.prototype, Nc.prototype, {
            _subscribe: function(a) {
              return ic(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), gc) : (this.observers.push(a), new Df(this, a));
            },
            hasObservers: function() {
        ...
        Bg = Pa.AnonymousSubject = function(a) {
          function b(b, c) {
        ...
        Cg = Pa.BehaviorSubject = function(a) {
          function b(b) {
            a.call(this), this.value = b, this.observers = [], this.isDisposed = !1, this.isStopped = !1, this.hasError = !1;
          }
          return Zb(b, a), $b(b.prototype, Nc.prototype, {
            _subscribe: function(a) {
              return ic(this), this.isStopped ? (this.hasError ? a.onError(this.error) : a.onCompleted(), gc) : (this.observers.push(a), a.onNext(this.value), new Df(this, a));
            },
            getValue: function() {
              return ic(this), this.hasError && e(this.error), this.value;
            },
            hasObservers: function() {
              return this.observers.length > 0;
            },
        ...
        Dg = Pa.ReplaySubject = function(a) {
          function b(a, b) {
            return fc(function() {
          ...
          function d(b, c, d) {
            this.bufferSize = null == b ? e : b, this.windowSize = null == c ? e : c, this.scheduler = d || zc, this.q = [], this.observers = [], this.isStopped = !1, this.isDisposed = !1, this.hasError = !1, this.error = null, a.call(this);
          }
          var e = Math.pow(2, 53) - 1;
          return Zb(d, a), $b(d.prototype, Nc.prototype, {
            _subscribe: function(a) {
              ic(this);
              var c = new Tc(this.scheduler, a),
                  d = b(this, c);
    ...
    Pa.Pauser = function(a) {
      ...
      return Zb(b, a), b.prototype.pause = function() {
        this.onNext(!1);
      }, b.prototype.resume = function() {
        this.onNext(!0);
      }, b;
    }(zg), "function" == typeof define && "object" == typeof define.amd && define.amd ? (Oa.Rx = Pa, define(function() {
      return Pa;
